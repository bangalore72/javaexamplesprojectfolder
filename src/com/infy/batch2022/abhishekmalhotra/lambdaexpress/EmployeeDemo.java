	...
	public static void main(String args[]) {
		...
		for (Employee e : empList) {
			...
			Consumer<Employee> beforeInc = emp -> System.out.println(
					e.getEmpName() + " (" + e.getEmpRole() + ") " +
							" had salary before Increment: " + e.getSalary());
			beforeInc.accept(e);

			// Increment Salary of only Managers using "Function":
			Function<Employee, Integer> salaryIncrease = 
					emp -> e.getEmpRole().equals("Manager") ? e.getSalary() + 5000
					: e.getSalary();
			
		    Integer upgradeSalary = salaryIncrease.apply(e);
			e.setSalary(upgradeSalary);
