...
public class TransactionProcessingUsingStreams {
	...
	public static void main(String[] args) {
		List<Transaction> transactionList = Arrays.asList(
				...
				new Transaction(1001014, LocalDateTime.of(2017, 4, 22, 9, 49, 19), "DR", "Paid electricity bill",
						672.0),
	...
	/*
	 * 
	 * static List<Transaction> filterById(List<Transaction> transactionList ,
	 * String id) {
	 * 
	 * List<Transaction> filteredList = transactionList.stream(). filter(t ->
	 * t.transationId.equals(id)).collect(Collectors.toList());
	 * 
	 * 
	 * return filteredList;
	 * 
